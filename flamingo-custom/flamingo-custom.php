<?php
/*
 * Plugin Name: Flamingo-custom
 * Description: A customize by jrd@uma.es of Flamingo plugin A trustworthy message storage plugin for Contact Form 7.
 * Author: José Carlos Ruiz
 * Author URI: https://ideasilo.wordpress.com/
 * License: GPL v2 or later
 * License URI: https://www.gnu.org/licenses/gpl-2.0.html
 * Text Domain: flamingo-custom
