...
function flamingo_inbound_fields_meta_box( $post ) {
	/****  Modificado por jrd@uma.es para cambiar la representación del field-value a un campo
	 * 		<INPUT type="text"> que pemita editar el valor del campo dentro del formulario
	 * 		Para posteriormente poder guardar los cambios en el POST
	 */
?>
...
<td class="field-value"><input type="text" size=40" name="<?php echo esc_html( $key ); ?>" value="<?php  echo is_array($value) ? flamingo_htmlize( $value ) : esc_html( $value); ?>"></td>
</tr>
<?php endforeach; ?>
