...
/* 
	En WordPress, la clase WP_List_Table se usa para mostrar datos, por ejemplo, usuarios, plugins, comentarios o entradas. 
	La clase contiene todos los métodos necesarios para mostrar, clasificar, paginar y buscar datos. 
*/
