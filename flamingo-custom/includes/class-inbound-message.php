...
class Flamingo_Inbound_Message {
	...
	public static function register_post_type() {
		// Registro un nuevo tipo de POST denominado flamingo_inbound
		...
		// Registra un estado para el post denominado Spam
		...
		// Registra una taxonomia denominada flamingo_inbound_channel
	...
	public static function find( $args = '' ) {
		//	Buscador de Posts de este tipo
		$defaults = array(
			'posts_per_page' => 10,
			'offset' => 0,
			'orderby' => 'ID',
	...
	public static function add( $args = '' ) {
		//	Añade un nuevo post de tipo flamingo_inbound
		$args = wp_parse_args( $args, array(
			'channel' => '',
			'status' => '',
			'subject' => '',
	...
	public function save() {
		//	Guarda un Post del tipo flamingo_inbound
		...
		// Actualiza un post con los elementos indicados en la matrix $postarr
